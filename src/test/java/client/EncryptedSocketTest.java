...
public class EncryptedSocketTest {
    ...
    public void t() {
        ...
        ZMQ.Socket server = hyper.createServerSocket(ZMQ.PUSH, "server", "tcp://*:7210");
        assertNotNull(server);

        ZMQ.Socket client = hyper.createClientSocket(ZMQ.PULL, "client", "server", "tcp://127.0.0.1:7210");
